      ...
      return (
        ...
        ברכות, נמצאת מתאים להיות יזם!
          ...
          <Animatable.View
            ...
            duration={1400}
            style={{
              flex: 5, paddingLeft: wp('20%'), paddingHorizontal: wp('20%'), position: 'absolute', paddingTop: hp('45%'), flexDirection: 'row', alignItems: 'space-between',
            }}
          >
          ...
          <Animatable.Text
            ...
            duration={1400}
            style={{
              flex: 1, color: '#fff', fontSize: wp('4.5%'), fontWeight: '700', textAlign: 'center', paddingHorizontal: wp('6%'), marginTop: -hp('17%'),
            }}
          >
        בוא נשב על כוס קפה ונמריא את העסק שלך!
          </Animatable.Text>

          <Animatable.View animation="bounce" iterationCount={1} delay={4000} style={{ flex: 1, marginTop: -hp('13%') }}>
    ...
    return (
      ...
      על פי החישובים שלנו, אתה לא מתאים להיות יזם. אבל היי - עדיין תוכל להקים עסק מצליח!
        ...
        <Animatable.Text
          ...
          duration={1400}
          style={{
            flex: 0, color: '#fff', fontSize: wp('4.7%'), fontWeight: '700', position: 'absolute', paddingTop: hp('55%'),
          }}
        >
      בוא נשב על כוס קפה ונשפר את המצב!
        </Animatable.Text>

        <Animatable.View animation="bounce" iterationCount={1} delay={4000} style={{ paddingTop: hp('3%') }}>
